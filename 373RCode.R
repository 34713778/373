...
lines(RD2c296_distfit, RD2c296_distyfit, lwd=1)
...
lines(RD2c148_distfit, RD2c148_distyfit, lwd=1)
...
lines(RD2c074_distfit, RD2c074_distyfit, lwd=1)
...
plot(RD2c296_distfit, RD2c296_distyfit, lty=1, type="l", ylim=c(0,max(RD2c296_distyfit,RD2c148_distyfit,RD2c074_distyfit)), xlim=c(0,4), ylab = "Frequency", xlab = "RD2 NH3 Concentration (mg/L)", main = "Combined Distribution Model (1000 trials)")
lines(RD2c148_distfit, RD2c148_distyfit, lty=2)
lines(RD2c074_distfit, RD2c074_distyfit, lty=3)
lines(RD2c0296_distfit, RD2c0296_distyfit, col="red", lty=1)
legend(3, 300, legend=c("Year 1", "Year 2", "Year 3", "Year 4"),col=c("black", "black", "black", "red"), lty=c(1,2,3,1), cex=0.8)
